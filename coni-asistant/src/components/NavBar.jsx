...
const Navbar = ({ isLoggedIn, handleLogout }) => {
  ...
  return (
    <nav className="text-white bg-gray-900/40 p-1 w-full fixed top-0 left-0 right-0 backdrop-blur-lg flex justify-between items-center rounded-b-lg">
      ...
      {menuOpen && (
        <div className="menu lg:hidden absolute flex gap-3 flex-col justify-center top-16 right-2 bg-indigo-950 rounded-lg backdrop-blur-md text-white py-2 px-4 z-index space-y-2 w-max">
          <NavLink
            to="/home"
            className={({ isActive }) =>
              isActive ? "flex items-center bg-gradient-to-r from-teal-500 to-teal-600 rounded-lg w-full p-3 hover:text-gray-400 text-gray-50" : "flex items-center text-gray-100 hover:text-gray-400"
            }
            onClick={toggleMenu}
          >
            <FaHome className="mr-3" />
          ...
          <NavLink
            to="/projects"
            className={({ isActive }) =>
              isActive ? "flex items-center bg-gradient-to-r from-sky-500 to-blue-600 rounded-lg w-full p-3 hover:text-gray-50 text-gray-50" : "flex items-center text-gray-100 hover:text-gray-400"
            }
            onClick={toggleMenu}
          >
            <FaProjectDiagram className="mr-3" />
          ...
          <NavLink
            to="/tasks"
            className={({ isActive }) =>
              isActive ? "flex items-center bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg w-full p-3 hover:text-gray-50 text-gray-50" : "flex items-center text-gray-100 hover:text-gray-400"
            }
            onClick={toggleMenu}
          >
            <FaTasks className="mr-3" />
